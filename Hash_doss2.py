...
workbook = xlrd.open_workbook("E:\\PENS\\Semester 7\\Progress PA\\codingan\\Program\\Hasil_BCH_DOSS1.xls", on_demand=True)
worksheet = workbook.sheet_by_name("Sheet1")
workbook1 = xlrd.open_workbook("E:\\PENS\\Semester 7\\Progress PA\\codingan\\Program\\Hasil_BCH_Bob_doss2.xls", on_demand=True)
...
with open("E:\\PENS\\Semester 7\\Progress PA\\codingan\\Program\\output\\sudahujinist_Bob.csv", newline="") as f:
    reader = csv.reader(f)
    for row in reader:
        indeks.append(row)
prindek = []
